...
применение GOLEM для задачи поиска оптимального пайплайна машинного обучения для прогнозирования временных рядов.
...
применение GOLEM для идентификации структуры уравнения для акустических данных.
...
применение GOLEM для идентификации структуры дифференциальных уравнений в частных производных.
...
применение GOLEM для задачи идентификации Баесовсих сетей.
