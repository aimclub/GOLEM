...
def run_example():
    ...
    elapsed_time = 0
    num = 0
    while l_n <= sequential_count and elapsed_time < time_m:
        num += 1
        ...
        # initial = create_population(pop_size-1, initial) 
    ...
    # textfile = open(file + '_sequential' + ".txt", "a")    
