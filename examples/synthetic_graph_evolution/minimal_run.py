...
def run_tree_search(size=16, timeout=2, visualize=True):
    ...
    # Setup objective metric: edit distance to target graph
    edit_dist = partial(tree_edit_dist, target_graph)
    objective = Objective(edit_dist)
    ...
    if visualize:
        ...
        draw_graphs_subplots(target_graph, found_graph, titles=['Target', 'Solution'])
...
if __name__ == '__main__':
    ...
    """
    run_tree_search(visualize=True)
