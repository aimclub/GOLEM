...
class PipelineComposerRequirements(ComposerRequirements):
    ...
    :param primary: operation types for :class:`~golem.core.pipelines.node.PrimaryNode`s
    :param secondary: operation types for :class:`~golem.core.pipelines.node.SecondaryNode`s
