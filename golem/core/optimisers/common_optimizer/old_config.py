...
nodes = [Mutation(), Crossover(), Regularization(), Selection(), Evaluator()]
...
default_stages.append(Stage(runner=OneThreadRunner(), nodes=nodes, task_builder=FinalProcessingTask,
                            scheme=scheme, stop_fun=lambda f, a: bool(f),
