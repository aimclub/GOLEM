...
def get_rand_population(pop_size: int = 10) -> PopulationT:
    ...
    random_pop = [generate_labeled_graph('gnp', size=random.choice(graph_sizes), directed=True)
...
@pytest.mark.parametrize('success_rate', [0.1, 0.2])
