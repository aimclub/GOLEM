...
@pytest.mark.parametrize('generate_history', [[3, 4, create_individual],
                         ...
                         indirect=True)
@pytest.mark.parametrize('plot_type', [PlotTypesEnum.fitness_line_interactive, PlotTypesEnum.fitness_line,
                                       PlotTypesEnum.operations_animated_bar, PlotTypesEnum.fitness_box])
